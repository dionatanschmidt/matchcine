...
export const POOL = [
  // Filmes — 28 títulos com diversidade máxima de gênero, época, país e estilo
  { n: 'Mad Max: Estrada da Fúria', t: 'Filme' },
  { n: 'John Wick', t: 'Filme' },
  { n: 'Piratas do Caribe: A Maldição do Pérola Negra', t: 'Filme' },
  { n: 'As Aventuras de Pi', t: 'Filme' },
  { n: 'Invocação do Mal', t: 'Filme' },
  { n: 'Corra!', t: 'Filme' },
  { n: 'Matrix', t: 'Filme' },
  { n: 'Perdido em Marte', t: 'Filme' },
  { n: 'O Golpista do Tinder', t: 'Filme' },
  { n: 'Professor Polvo', t: 'Filme' },
  { n: 'Se Beber, Não Case!', t: 'Filme' },
  { n: 'O Auto da Compadecida', t: 'Filme' },
  { n: 'À Procura da Felicidade', t: 'Filme' },
  { n: 'Parasita', t: 'Filme' },
  { n: 'Diário de uma Paixão', t: 'Filme' },
  { n: '10 Coisas Que Eu Odeio em Você', t: 'Filme' },
  { n: 'Se7en - Os Sete Crimes Capitais', t: 'Filme' },
  { n: 'Um Lugar Silencioso', t: 'Filme' },
  { n: 'Toy Story', t: 'Filme' },
  { n: 'Homem-Aranha no Aranhaverso', t: 'Filme' },
  { n: 'Harry Potter e a Pedra Filosofal', t: 'Filme' },
  { n: 'O Labirinto do Fauno', t: 'Filme' },
  { n: 'O Senhor dos Anéis', t: 'Filme' },
  { n: 'Star Wars', t: 'Filme' },
  { n: 'O Poderoso Chefão', t: 'Filme' },
  { n: 'Os Vingadores', t: 'Filme' },
  { n: 'Avatar', t: 'Filme' },
  { n: 'Titanic', t: 'Filme' },
  // Diretores — 8 estilos opostos
  { n: 'Steven Spielberg', t: 'Diretor' },
  { n: 'Christopher Nolan', t: 'Diretor' },
  { n: 'Quentin Tarantino', t: 'Diretor' },
  { n: 'Martin Scorsese', t: 'Diretor' },
  { n: 'James Cameron', t: 'Diretor' },
  { n: 'Greta Gerwig', t: 'Diretora' },
  { n: 'Jordan Peele', t: 'Diretor' },
  { n: 'Denis Villeneuve', t: 'Diretor' },
  // Atores/Atrizes — 8 com reconhecimento imediato
  { n: 'Leonardo DiCaprio', t: 'Ator' },
  { n: 'Tom Cruise', t: 'Ator' },
  { n: 'Adam Sandler', t: 'Ator' },
  { n: 'Meryl Streep', t: 'Atriz' },
  { n: 'Wagner Moura', t: 'Ator' },
  { n: 'Dwayne Johnson', t: 'Ator' },
  { n: 'Zendaya', t: 'Atriz' },
  { n: 'Anya Taylor-Joy', t: 'Atriz' },
];

export const POOL_TV = [
  // Séries — 28 títulos
  { n: 'Breaking Bad', t: 'Série' },
  { n: 'Friends', t: 'Série' },
  { n: 'Stranger Things', t: 'Série' },
  { n: 'Game of Thrones', t: 'Série' },
  { n: 'The Office', t: 'Série' },
  { n: 'La Casa de Papel', t: 'Série' },
  { n: 'Dark', t: 'Série' },
  { n: 'Succession', t: 'Série' },
  { n: 'Round 6', t: 'Série' },
  { n: 'Chernobyl', t: 'Série' },
  { n: 'Fleabag', t: 'Série' },
  ...
  { n: 'The Bear', t: 'Série' },
  { n: 'Black Mirror', t: 'Série' },
  { n: 'Narcos', t: 'Série' },
  { n: 'The Crown', t: 'Série' },
  { n: 'Wandinha', t: 'Série' },
  { n: 'Manifest', t: 'Série' },
  { n: 'Grey\'s Anatomy', t: 'Série' },
  { n: 'Peaky Blinders', t: 'Série' },
  { n: 'Casa do Dragão', t: 'Série' },
  { n: 'Euphoria', t: 'Série' },
  { n: 'Ted Lasso', t: 'Série' },
  { n: 'Sintonia', t: 'Série' },
  { n: 'The Mandalorian', t: 'Série' },
  { n: 'Mare of Easttown', t: 'Série' },
  // Showrunners — 8
  { n: 'Shonda Rhimes', t: 'Showrunner' },
  { n: 'Ryan Murphy', t: 'Showrunner' },
  ...
  // Atores/Atrizes — 8
  { n: 'Bryan Cranston', t: 'Ator' },
  { n: 'Millie Bobby Brown', t: 'Atriz' },
  { n: 'Juliana Paes', t: 'Atriz' },
  { n: 'Pedro Pascal', t: 'Ator' },
  { n: 'Zendaya', t: 'Atriz' },
  { n: 'Jenna Ortega', t: 'Atriz' },
  { n: 'Wagner Moura', t: 'Ator' },
  { n: 'Sandra Oh', t: 'Atriz' },
];
